...
from .models import Product, OrderProduct, Order, Payment, Coupon, Refund, Address, UserProfile
...
class AddressAdmin(admin.ModelAdmin):
    list_display = ['user', 'address1', 'address2', 'country', 'zip', 'address_type', 'default']
    list_filter = ['default', 'address_type', 'country']
    search_fields = ['user', 'address1', 'address2', 'zip']
